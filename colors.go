...
{"maroon", buildStyle(TrueColor.WithHex("#800000").WithBgHex("#b03060"))},
{"navy", buildStyle(TrueColor.WithHex("#000080").WithBgHex("#00008b"))},
{"indigo", buildStyle(TrueColor.WithHex("#4b0082").WithBgHex("#191970"))},
{"fuchsia", buildStyle(TrueColor.WithHex("#ff00ff").WithBgHex("#ff00ff"))},
{"silver", buildStyle(TrueColor.WithHex("#c0c0c0").WithBgHex("#808080"))},
{"olive", buildStyle(TrueColor.WithHex("#808000").WithBgHex("#556b2f"))},
{"cherry", buildStyle(TrueColor.WithHex("#de3163").WithBgHex("#fc8d62"))},
{"mint", buildStyle(TrueColor.WithHex("#98ff98").WithBgHex("#00ff7f"))},
{"chocolate", buildStyle(TrueColor.WithHex("#d2691e").WithBgHex("#8b4513"))},
{"lemon", buildStyle(TrueColor.WithHex("#fff44f").WithBgHex("#f5deb3"))},
{"grape", buildStyle(TrueColor.WithHex("#6f2da8").WithBgHex("#a020f0"))},
{"sky", buildStyle(TrueColor.WithHex("#87ceeb").WithBgHex("#00bfff"))},
{"peppermint", buildStyle(TrueColor.WithHex("#c8a2c8").WithBgHex("#7b68ee"))},
{"brick", buildStyle(TrueColor.WithHex("#b22222").WithBgHex("#8b0000"))},
{"rose", buildStyle(TrueColor.WithHex("#ff007f").WithBgHex("#ffb6c1"))},
{"steel", buildStyle(TrueColor.WithHex("#4682b4").WithBgHex("#708090"))}
	ColorHelpMsg = ""
)
