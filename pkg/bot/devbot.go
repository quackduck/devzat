...
func (b *DevBot) Say(line string) {
	if b.room == nil {
		return
	}

	b.Room().Broadcast(b.name, line)
}

func (b *DevBot) PickUsername(_ string) error {
	// name is hardcoded, but we have this method to implement an interface
	return nil
}
...
func (b *DevBot) RespondTo(line string) {
...
func (b *DevBot) ListenFor(these ...string) i.ResponseBuilder {
	r := &responseRule{}
...
func (b *DevBot) ListenForExactly(these ...string) i.ResponseBuilder {
	r := &responseRule{}
