...
Devzat now has an integration with WolfRam Alpha, allowing users to ask questions to the API. This plugin is now avilible for  your own Devzat instance! For more details and installation instructions, please check out the [Admin's Manual](https://github.com/quackduck/devzat/blob/main/Admin's%20Manual.md#using-the-wolfram-alpha-integration).
